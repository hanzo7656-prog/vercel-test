# command_system.py
# ============================================================
# سیستم دستوری - نسخه ۲.۰ (یکپارچه با Scheduler)
# ============================================================
...
class CommandSystem:
    ...
    def __init__(self, analyzer: NumericAnalyzer):
        ...
        logger.info("✅ CommandSystem v2.0 initialized")
            ...
            if self.db and self.db.is_connected():
                ...
                if result:
                    ...
                    for row in result:
                        ...
                        if time:
                            time = time[:16]  # فقط تاریخ و ساعت
                        response += f"  • {row.get('command')} ({time})\n"
                    return response
