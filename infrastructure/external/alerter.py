# infrastructure/external/alerter.py
# ============================================================
# سیستم هشدار و اعلان - نسخه ۴.۰ (انتقال به Infrastructure)
# ============================================================
...
class Alerter:
    ...
    ✅ نسخه ۴.۰: انتقال به Infrastructure
    ✅ Type Hints کامل
    ✅ تلگرام کامنت شده (غیرفعال)
    """
    ...
    def __init__(self) -> None:
        ...
        # استفاده از Scheduler برای دریافت متریک
        ...
        logger.info("✅ Alerter v4.0 initialized (Telegram disabled)")
